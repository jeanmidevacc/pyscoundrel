...
class RetroTheme:
    ...
    def get_rich_theme(cls) -> Theme:
        ...
        return Theme({
            ...
            # Suits
            "suit.black": Style(color=cls.COLORS["slate"]),
            "suit.red": Style(color=cls.COLORS["danger_red"]),
            ...
            "choice.highlight": Style(color=cls.COLORS["warning_amber"], bold=True, reverse=True),
    ...
    @classmethod
    def get_card_color(cls, card_type: str, is_red_suit: bool = False) -> str:
